            ...
            <div class="relative mx-auto w-full">
                ...
                <div class="shadow p-4 rounded-lg bg-white">
                    ...
                    <div class="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                        <img src="https://images.unsplash.com/photo-1523217582562-09d0def993a6?q=80&w=1780&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
                    </div>
                    ...
                    <span class="absolute top-0 left-0 inline-flex mt-3 ml-3 px-3 py-2 rounded-lg z-10 bg-indigo-700 text-sm font-medium text-white select-none">
                        Accepted
                    </span>
                    </div>
                    ...
                    <div class="grid grid-cols-2 mt-8">
                        <div class="flex items-center">
                            ...
                            <div class="rounded-full w-6 h-6 md:w-8 md:h-8 ">
                                <img className="rounded-full w-12 h-11 md:w-8 md:h-8 "  src="https://www.perfocal.com/blog/content/images/2021/01/Perfocal_17-11-2019_TYWFAQ_100_standard-3.jpg"/>
                            </div>
                            </div>
                    ...
                    <button class="relative align-middle select-none font-sans font-medium text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none w-10 max-w-[40px] h-10 max-h-[40px] rounded-lg text-xs bg-gray-900 text-white shadow-md shadow-gray-900/10 hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none" type="button">
        ...
        <i class="fas fa-trash" aria-hidden="true"></i>
            ...
            <div class="relative mx-auto w-full">
                ...
                <div class="shadow p-4 rounded-lg bg-white">
                    <div class="flex justify-center relative rounded-lg overflow-hidden h-52">
                    <div class="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ3cRMDxFzhAdUYw9hP9AKbKkIfyXb7rt6AMw&s" alt="" />
                    </div>
                    ...
                    <div class="grid grid-cols-2 mt-8">
                        <div class="flex items-center">
                            <div class="relative">
                            <div class="rounded-full w-6 h-6 md:w-8 md:h-8 ">
                                <img className="rounded-full w-12 h-11 md:w-8 md:h-8 "  src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8dXNlcnxlbnwwfHwwfHx8MA%3D%3D"/>
                            </div>
                            </div>
        ...
        <i class="fas fa-trash" aria-hidden="true"></i>
            ...
            <div class="relative mx-auto w-full">
                ...
                <div class="shadow p-4 rounded-lg bg-white">
                    <div class="flex justify-center relative rounded-lg overflow-hidden h-52">
                    <div class="transition-transform duration-500 transform ease-in-out hover:scale-110 w-full">
                        <img src="https://www.henge07.com/app/uploads/2023/04/Chalet-Kitzbuehel-5.jpg" alt="" />
                    </div>
                    ...
                    <div class="grid grid-cols-2 mt-8">
                        <div class="flex items-center">
                            <div class="relative">
                            <div class="rounded-full w-6 h-6 md:w-8 md:h-8 ">
                                <img className="rounded-full w-12 h-11 md:w-8 md:h-8 "  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDJzEaxLN-jGRYYUO65pWu7Q9GXoNt4LUSSA&s"/>
                            </div>
                            </div>
