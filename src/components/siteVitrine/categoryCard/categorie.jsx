...
import house2 from '../../../assets/house10.jpg'
import house3 from '../../../assets/house11.jpg'
import house4 from '../../../assets/house12.jpg'
import house5 from '../../../assets/house13.jpg'
import house6 from '../../../assets/house14.jpg'
import house7 from '../../../assets/house12.jpg'
import house8 from '../../../assets/house11.jpg'
import house9 from '../../../assets/house1.jpg'
const PropertyList = () => {

  return (
  
    <div className='py-10 w-11/12' >
    <p className='px-4 py-1 text-xs bg-blue-100 w-16 rounded-lg'>NEW</p>
    ...
    <button className='bg-blue-900 px-5 py-2 rounded-md text-xl text-white flex items-center space-x-2'><span>View More</span> <AiOutlineDoubleRight/></button>
    </div>
</div>
